...
public class SortingConstants {
    ...
    public static final String SORT_DROPDOWN = "select.input.py-2.pr-8.pl-3.text-sm.appearance-none.cursor-pointer";

    // Sorting options (values from <option>)
