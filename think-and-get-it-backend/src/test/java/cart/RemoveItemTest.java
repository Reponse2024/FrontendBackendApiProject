...
public class RemoveItemTest {
    ...
    public void removeItemFromCart() {
        ...
        Response response = cartFlow.removeItemFromCart(getRequestSpec(), itemId);
        ResponseAssertions.assertSuccess(response, HttpStatus.OK.code(), ResponseMessages.ITEM_REMOVED);
    }
}
