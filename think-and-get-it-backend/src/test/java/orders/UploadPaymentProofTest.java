...
public class UploadPaymentProofTest {
    ...
    public void uploadPaymentProofSuccessfully() {
        Response response = new OrderFlow().uploadPaymentProof(getRequestSpec());
    ...
    public void uploadPaymentProofFailsWithoutFile() {
        ...
        ResponseAssertions.assertFailure(response, HttpStatus.BAD_REQUEST.code(), ResponseMessages.FILE_REQUIRED);
    }
