...
public class AddAddressTest {
    ...
    public void addAddress() {
        Response response = new UserFlow().addAddress(getRequestSpec());
        ...
        Assert.assertEquals(response.jsonPath().getString(ResponsePaths.MESSAGE), UserResponseMessages.ADDRESS_ADDED);
    }
}
